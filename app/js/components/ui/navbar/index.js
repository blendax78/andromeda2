...
class Navbar extends Component {
  ...
  showToDos() {
    let todos = [
      ...
      <li key={Config.randomKey('li')}>Tweak mob combat speed</li>,
      ...
      <li key={Config.randomKey('li')}>Autogenerated/Terraformed worlds and generated monsters</li>,
      <li key={Config.randomKey('li')}>Redo database</li>,
      <li key={Config.randomKey('li')}>Prevent overwriting db with test data!!!!</li>,
      <li key={Config.randomKey('li')}>Idea - quasi-player that stalks player</li>
    ];
