...
class Navbar extends Component {
  ...
  showToDos() {
    let todos = [
      ...
      <li key={Config.randomKey('li')}>Exceptional Armor</li>,
      ...
      <li key={Config.randomKey('li')}>(Eventually) Autogenerated worlds (python job that generates js? middleware will be used here)</li>,
